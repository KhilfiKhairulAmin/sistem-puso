...
# Menguji data get[jenis]==Ujian 
if ($_GET['jenis'] == "Ujian") {
    # memanggil fail timer2.php
    include('../timer2.PHP');
    # memanggil fungsi timer_Ujian
    timer_Ujian($_GET['masa']);
}
?>
...
<hr>
<form name='soalan_Ujian' action='jawab_semak.php?no_set=<?PHP echo $_GET['no_set']; ?>' method='POST'>
    <?PHP include('../butang_saiz_tulisan.php'); ?>
    <table class='w3-table-all w3-margin-top' border='1' width='50%' id='besar'>
        <tr class="w3-blue">
            <td>Bil</td>
            <td>Soalan</td>
        </tr>
...
<input type='radio' name='s" . $data['no_soalan'] . "' value='" . $a[0] . "|" . $data[$a[0]] . "|" . $data[$a[0]] . "|" . $data[$a[1]] . "|" . $data[$a[2]] . "|" . $data[$a[3]] . "|" . $soalan . "|" . $data['jawapan_a'] . "|" . $gambar . "'> <label>" . $data[$a[0]] . "</label><br>

<input type='radio' name='s" . $data['no_soalan'] . "' value='" . $a[1] . "|" . $data[$a[1]] . "|" . $data[$a[0]] . "|" . $data[$a[1]] . "|" . $data[$a[2]] . "|" . $data[$a[3]] . "|" . $soalan . "|" . $data['jawapan_a'] . "|" . $gambar . "'> <label>" . $data[$a[1]] . "</label><br>

<input type='radio' name='s" . $data['no_soalan'] . "' value='" . $a[2] . "|" . $data[$a[2]] . "|" . $data[$a[0]] . "|" . $data[$a[1]] . "|" . $data[$a[2]] . "|" . $data[$a[3]] . "|" . $soalan . "|" . $data['jawapan_a'] . "|" . $gambar . "'> <label>" . $data[$a[2]] . "</label><br>

<input type='radio' name='s" . $data['no_soalan'] . "' value='" . $a[3] . "|" . $data[$a[3]] . "|" . $data[$a[0]] . "|" . $data[$a[1]] . "|" . $data[$a[2]] . "|" . $data[$a[3]] . "|" . $soalan . "|" . $data['jawapan_a'] . "|" . $gambar . "'> <label>" . $data[$a[3]] . "</label>
